  ...
  return (
    <div>
            ...
            <div className="col-lg-7">
              <div className="d-inline-flex align-items-center rounded-pill bg-secondary bg-opacity-25 px-3 py-2 mb-3 border border-secondary border-opacity-25">
                ...
                <small className="fw-semibold">
                  Job-Oriented Software Testing Automation Program • Limited
                  Seats
                </small>
              </div>
              ...
              <p className="fs-5 text-white-50 mb-4 col-lg-10">
                Master Manual Testing, Java, Selenium WebDriver, TestNG, Maven,
                Frameworks, API Testing, Database Testing, Jenkins CI, and work
                on live projects with placement-focused training.
              </p>
              ...
              <div className="d-flex flex-wrap gap-2 mb-4">
                ...
                <div className="badge rounded-pill bg-light bg-opacity-10 text-white fw-normal px-3 py-2 border border-light border-opacity-25">
                  <i className="fa-solid fa-briefcase me-2"></i> 100% Placement
                  Assistance
                </div>
              </div>
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-7">
              ...
              <p className="lead fs-6 text-dark">
                ...
                <strong>
                  {" "}
                  Java programming, Selenium WebDriver, frameworks, API testing,
                  and CI tools
                </strong>
                .
              </p>
              ...
              <ul className="list-unstyled mt-4 vstack gap-2 text-dark">
                <li>
                  ...
                  Ideal for freshers & non-IT backgrounds.
                </li>
                <li>
                  <i className="fa-solid fa-check-circle text-success me-2"></i>{" "}
                  Hands-on automation using Java, Selenium & TestNG.
                </li>
                <li>
                  <i className="fa-solid fa-check-circle text-success me-2"></i>{" "}
                  API testing, database testing & real project.
                </li>
              </ul>
            </div>
        ...
        <div className="container py-4">
          ...
          >
            <h2 className="fw-bold mb-2">
              Software Testing Automation – Curriculum
            </h2>
            <p className="text-white">
              Complete journey from Manual Testing to building automation
          ...
          <div className="row g-4">
            {[
              ...
              {
                title: "Manual Testing in Detail",
                mod: "2",
                items: [
              ...
              {
                title: "Introduction to Automation & Selenium",
                mod: "4",
                items: [
                  "Why Automation?",
                  "Selenium Suite",
              ...
              {
                title: "WebDriver Locators & Actions",
                mod: "5",
                items: [
                  "Locators",
                  "WebElements",
              ...
              {
                title: "Synchronization & Advanced WebDriver",
                mod: "6",
                items: [
                  "Waits",
                  "WebDriverWait",
              ...
              {
                title: "Automation Frameworks & POM",
                mod: "9",
                items: [
                  "Hybrid",
                  "Data-Driven",
              ...
              },
              {
                ...
                mod: "10",
                items: ["Apache POI", "Parameterization", "DataProviders"],
              },
              {
                title: "API Testing with Postman",
                mod: "11",
                items: ["REST Basics", "GET/POST", "Collections", "Assertions"],
              },
              {
                title: "Database Testing (MySQL)",
                mod: "12",
                items: ["SQL Basics", "CRUD", "Joins", "DB Validation"],
              },
              {
                title: "Jenkins & CI Basics",
                mod: "13",
                items: [
                  "CI/CD",
                  "Installing Jenkins",
              ...
              {
                title: "Live Project & Interview Prep",
                mod: "15",
                items: [
            ...
            <div className="bg-dark text-white rounded-4 p-4 d-flex flex-wrap align-items-center justify-content-between gap-3 shadow">
              <div>
                ...
                <div className="fw-semibold">
                  Get complete Automation Testing syllabus & fee structure on
                  WhatsApp.
                </div>
              </div>
              <div className="d-flex gap-2">
                <a href="#enquiry" className="btn btn-warning fw-semibold">
                  Send Me Syllabus
                </a>
      ...
      <section className="py-5 bg-white" id="tools">
        <div className="container py-4">
          <h2 className="fw-bold text-center text-dark mb-2">
          ...
          <div className="row g-4 justify-content-center">
            {[
              ...
              },
              {
                ...
                icon: "fa-gears",
                items: ["Postman", "MySQL", "Jenkins", "JIRA"],
              },
              {
              ...
              <div className="col-md-4" key={idx}>
                <div className="text-center p-3 border rounded-4 h-100 bg-light bg-opacity-25">
                  <h6 className="fw-bold mb-3 text-dark">
                    <i
                      className={`fa-solid ${section.icon} me-2 text-primary`}
                    ></i>
                    {section.title}
                  </h6>
                  <div className="d-flex flex-wrap gap-2 justify-content-center">
                    {section.items.map((tool, i) => (
                      <span
                        key={i}
                        className="badge bg-white text-dark border fw-normal py-2 px-3"
                      >
                        {tool}
                      </span>
                    ))}
      ...
      <section className="py-5 bg-primary bg-opacity-10" id="career">
        <div className="container py-4">
          ...
          <p
            className="text-white text-center mb-5 mx-auto"
            style={{ maxWidth: "600px" }}
          >
            Softgrowth Infotech supports you till you crack interviews and start
            your testing career.
          </p>
            ...
            {[
              {
                ...
                text: "Build a strong QA/Automation Tester resume.",
              },
              {
                icon: "fa-people-arrows",
                title: "Mock Interviews",
                text: "Manual + Automation interview practice.",
              },
              {
                icon: "fa-building",
                title: "Interview Opportunities",
                text: "Placement assistance with interview calls.",
              },
              {
                icon: "fa-user-graduate",
                title: "Career Guidance",
                text: "Guidance on career roadmap & growth.",
              },
            ].map((item, idx) => (
              <div className="col-md-6 col-lg-3" key={idx}>
                <div className="card h-100 border-0 shadow-sm rounded-4 text-center">
                  <div className="card-body p-4">
                    ...
                    >
                      <i
                        className={`fa-solid ${item.icon} text-danger fs-5`}
                      ></i>
                    </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="accordion" id="faqAccordion">
                {[
                  {
                    q: "I am from non-IT background. Can I join?",
                    a: "Yes! We start from Manual Testing basics.",
                  },
                  {
                    q: "Do you cover both Manual & Automation Testing?",
                    a: "Yes, complete Manual + Automation with Java & Selenium.",
                  },
                  {
                    q: "Will I work on a live project?",
                    a: "Yes. You will build a full automation framework.",
                  },
                  {
                    q: "Do you provide placement assistance?",
                    a: "Yes! Resume prep, mock interviews, and job calls.",
                  },
                  {
                    q: "How can I know the latest fees & batch dates?",
                    a: "Fill the form or call us at +91 88886 54507.",
                  },
                ].map((faq, idx) => (
                  <div
