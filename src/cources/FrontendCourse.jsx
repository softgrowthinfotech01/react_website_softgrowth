          ...
          <div className="row g-5 align-items-start">
            ...
            <div className="col-lg-7">
              ...
              <p className="fs-5 text-white-50 mb-4 col-lg-10">
                Master HTML5, CSS3, Bootstrap 5, Tailwind CSS, JavaScript,
                React.js, Angular, Git & GitHub with live projects, mock
                interviews, and placement-focused training.
              </p>
              ...
              <div className="card border-0 shadow-lg rounded-4 text-dark">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted small mb-3">
                    Fill the form to get a call back with detailed syllabus PDF,
                    fees, and nearest batch.
                  </p>
                  ...
                  <form>
                    ...
                    >
                      By submitting, you agree to be contacted via call /
                      WhatsApp / SMS.
                    </p>
                  </form>
                </div>
      ...
      <section className="py-5 bg-white" id="overview">
        <div className="container py-4">
          <div className="row g-5 align-items-center">
            <div className="col-lg-7">
              <div className="badge rounded-pill  text-dark bg-warning border px-3 py-2 mb-3">
                <i className="me-2"></i>
                Industry-Oriented Front-End Development Training
              </div>
              <h2 className="fw-bold mb-3 text-dark">
                Why Front-End Development at Softgrowth Infotech?
              </h2>
              <p className=" lead fs-6 text-dark">
                Front-end developers are in high demand across startups, product
                companies, and MNCs. This course is designed to take you from
                basic web design to building
                <strong>
                  {" "}
                  modern, responsive, and component-based web applications
                </strong>
                .
              </p>
              ...
              <ul className="list-unstyled mt-4 vstack gap-2 text-dark">
                <li>
                  ...
                  Perfect for beginners and non-IT graduates.
                </li>
                <li>
                  <i className="fa-solid fa-check-circle text-success me-2"></i>{" "}
                  Multiple mini-projects + 4 live projects.
                </li>
                <li>
                  <i className="fa-solid fa-check-circle text-success me-2"></i>{" "}
                  Mock interviews, resume guidance & placement support.
                </li>
              </ul>
            </div>
                ...
                {[
                  {
                    ...
                    text: "Implementation-focused sessions with practical examples.",
                  },
                  {
                    icon: "fa-user-tie",
                    title: "Mentors from Industry",
                    text: "Learn from experienced front-end developers.",
                  },
                  {
                    icon: "fa-layer-group",
                    title: "Live Project",
                    text: "Work on a real project from design to deployment.",
                  },
                  {
                    icon: "fa-certificate",
                    title: "Certificate & Support",
                    text: "Course certificate + interview support.",
                  },
                ].map((item, index) => (
        ...
        <div className="container py-4">
          ...
          >
            ...
            <p className="text-white">
              Step-by-step journey from basic web pages to professional
              applications.
            </p>
          </div>
          ...
          <div className="row g-4">
            {[
              ...
              },
              {
                title: "Live Project",
                mod: "10",
                items: ["UI/UX", "Build", "Hosting", "Portfolio"],
              },
              {
                title: "Career Prep",
                mod: "11",
          ...
          <div className="row g-4 justify-content-center">
            {[
              ...
              },
              {
                title: "Dev Tools",
                icon: "fa-gears",
                items: ["Git", "GitHub", "VS Code", "DevTools", "Figma"],
              },
            ].map((section, idx) => (
      ...
      <section className="py-5 bg-primary bg-opacity-10" id="career">
        <div className="container py-4">
          ...
          <p
            ...
            style={{ maxWidth: "600px" }}
          >
            Softgrowth Infotech prepares you not only to learn but also to get
            job-ready.
          </p>
            ...
            {[
              {
                ...
                text: "Create a strong front-end resume with your projects.",
              },
              {
                icon: "fa-people-arrows",
                title: "Mock Interviews",
                text: "Technical + HR mock interviews to boost confidence.",
              },
              {
                icon: "fa-building",
                title: "Interview Calls",
                text: "Placement assistance through interview calls shared.",
              },
              {
                icon: "fa-user-graduate",
                title: "Career Guidance",
                text: "Guidance on pathways, freelancing & portfolio.",
              },
            ].map((item, idx) => (
