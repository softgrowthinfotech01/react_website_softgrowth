            ...
            <div className="row mb-5">
              ...
              >
                <div className="image-container px-5">
                  <img
                    src="./src/assets/landing-image1.jpg"
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div
                ...
                style={{
                  backgroundImage: 'url("src/assets/services-image.jpg")',
                }}
                data-aos="fade-left"
                data-aos-delay={100}
              />
        ...
        <section id="portfolio" className="portfolio">
          <div className="container">
            <div className="section-title" data-aos="fade-up">
              ...
              <p>
                We have worked with Static Websites, Dynamic Websites and many
                types of Websites
              </p>
            </div>
            ...
            >
              <div className="col-lg-4 col-md-6 portfolio-item filter-dynamic">
                <div className="portfolio-wrap">
                  <img
                    src="assets/portfolio/bhumi_logo.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    ...
                    <div className="portfolio-links">
                      <a
                        href="assets/portfolio/bhumi_logo.webp"
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                <div className="portfolio-wrap">
                  <img
                    src="assets/portfolio/wildlife_adventure.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    ...
                    <div className="portfolio-links">
                      <a
                        href="assets/portfolio/wildlife_adventure.webp"
                        data-gallery="portfolioGallery"
                        className="portfolio-lightbox"
                        title="Web 3"
                      >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item filter-dynamic">
                <div className="portfolio-wrap">
                  <img
                    src="assets/portfolio/elysian.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    ...
                    <div className="portfolio-links">
                      <a
                        href="assets/portfolio/elysian.webp"
                        data-gallery="portfolioGallery"
                        className="portfolio-lightbox"
                        title="App 2"
                      >
          ...
          <div className="container">
            ...
            <div className="row mx-0" id="" data-aos="fade-up">
              <div className="col-lg-4 col-md-12 mb-4 px-2  ">
                ...
                >
                  <img
                    src="src/assets/gallary/classroom.png"
          ...
          <div className="container">
            ...
            <div className="row align-items-center">
              <div className="col-lg-3 col-md-4 col-6" data-aos="zoom-in">
                <img
                  src="assets/company_logos/codewiz.jpeg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/cognizant.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/mnj.png"
              ...
              >
                <img
                  src="assets/company_logos/plus91.jpg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/singlepoint.png"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/capita.jpeg"
              ...
              >
                <img
                  src="assets/company_logos/adox.png"
                  className="img-fluid w-25"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/Capgemini.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/Volody.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/radiant.png"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/kumaran.png"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/Quick_Heal.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/deloitte.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/hexaware.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/infosys.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
              ...
              >
                <img
                  src="assets/company_logos/tcs.svg"
                  className="img-fluid"
                  alt=""
                />
              </div>
            ...
            <ul className="faq-list">
              <li data-aos="fade-up">
                ...
                <div id="faq1" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    ...
                    development services, including web development with Static
                    and Dynamic websites. We also offer IT consulting and system
              ...
              <li data-aos="fade-up" data-aos-delay={200}>
                ...
                <div id="faq3" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    Our team is proficient in a wide range of programming
                    languages and technologies, including but not limited to,
                    JavaScript, PHP, Angular, React. We stay updated with the
                    latest trends to deliver cutting-edge solutions.
                  </p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-delay={300}>
                ...
                <div id="faq4" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    ...
                    resources and expertise to handle complex and extensive
              ...
              <li data-aos="fade-up" data-aos-delay={400}>
                ...
                <div id="faq5" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    ...
                    regular contact with our clients through meetings, emails,
                    and project management tools. We ensure that clients are
                    updated on progress and any changes throughout the project.
                  </p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-delay={500}>
                ...
                <div id="faq6" className="collapse" data-bs-parent=".faq-list">
                  <p>
                    ...
                    maintenance services to ensure the smooth functioning of
                    your software. Our team is available to address any issues,
                    implement updates, and provide ongoing support.
                  </p>
                </div>
              </li>
            </ul>
